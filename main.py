...
def register():
    ...
    if registration_form.validate_on_submit():
        name = registration_form.name.data.capitalize()
...
def login():
    ...
    if log_in_form.validate_on_submit():
        ...
        if not user:
            ...
            flash("Invalid password. Please try again or reset your password.")
            return redirect(url_for('login'))
...
def show_post(post_id):
    ...
    if comment_form.validate_on_submit():
        ...
        if current_user.is_authenticated:
            new_comment = Comment(text=comment, comment_author = current_user, post = requested_post)
